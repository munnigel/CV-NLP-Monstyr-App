...
Then(
  'the start date of the promotion should appear in the "Start Date" text box',
  () => {
...
Then(
  'the end date of the promotion should appear in the "End Date" text box',
  () => {
...
Given(
  'I am on "Edit Item Page" for a particular pending post with no date',
  () => {
    cy.visit("http://localhost:4200");
    cy.get("#loginEmail").type("nigel_mun@mymail.sutd.edu.sg");
    cy.get("#loginPassword").type("123123");
