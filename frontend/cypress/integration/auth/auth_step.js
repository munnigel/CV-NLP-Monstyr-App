...
And(
  "The registered account has been verified via the confirmation link sent to the email address",
  () => {
...
And(
  "The registered account has not been verified via the confirmation link sent to the email address",
  () => {
    cy.request({
      method: "POST",
